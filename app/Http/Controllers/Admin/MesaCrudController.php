 ...
 */
class MesaCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\Mesa::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/mesa');
    ...
    {
        CRUD::setValidation(MesaRequest::class);
